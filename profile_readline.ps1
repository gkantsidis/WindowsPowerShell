...
# The following are from https://raw.githubusercontent.com/lzybkr/PSReadLine/master/PSReadLine/SamplePSReadlineProfile.ps1
...
Set-PSReadlineKeyHandler -Key '"',"'" `
    ...
    if (($quoteNumber) -and ($quoteNumber.Matches) -and ($quoteNumber.Matches.Count % 2 -eq 1)) {
        # Oneven amount of quotes, put just one quote
        [Microsoft.PowerShell.PSConsoleReadline]::Insert($key.KeyChar)
    }
    elseif (($cursor -lt $line.Length) -and ($line[$cursor] -eq $key.KeyChar)) {
